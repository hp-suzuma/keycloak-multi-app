...
class ObjectDeleteControllerTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_it_requires_the_object_delete_permission(): void
    {
        ...
        $response = $this->deleteJson('/api/objects/'.$managedObject->id);
